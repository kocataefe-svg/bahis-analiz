...
export function buildTeamAndCommentaryPrompt(input: AnalysisPromptInput): string {
  return [
    ...
    "Eger asagida ilk yari, handikap veya gol atacak oyuncu pazarlarindan veri varsa, bunlardan SADECE BIRINE (hepsine degil) tek bir nitel cumleyle kisaca deginsin (orn. 'ilk yaride de ev sahibi hafif favori'). Digerlerini tamamen atla - hepsini tek tek siralamak YASAK, bu verileri tamamen yok saymak da YASAK.",
    "ONEMLI - net tahmin kurali ve FORMAT: Yorumcu, Taraf Bahsi/2.5/KG pazarlarinin HER BIRI icin ayri bir 'Tahminim: ...' cumlesiyle bitirmeli. Format TAM OLARAK boyle olmali: Taraf Bahsi icin 'Tahminim: MS [takim adi]' veya 'Tahminim: MS Beraberlik'; 2.5 pazari icin 'Tahminim: 2.5 Ust' veya 'Tahminim: 2.5 Alt'; KG pazari icin 'Tahminim: KG Var' veya 'Tahminim: KG Yok'. ASLA takim adinin hemen yanina cikti rakami yazma (orn. 'Tahminim: Ajax 1' gibi bir format YOK - bu kafa karistirir, KULLANMA). 'Kesin bir sey soylemek zor', 'net bir tahminde bulunmak guc', 'iki yonlu de olasi' gibi cekingen/kacamak ifadeler YASAK - elindeki bilgiyle bir tarafi sec ve acikca soyle. Bu bir kesinlik iddiasi degil, olasilik degerlendirmesidir ama yine de net olmali.",
    "Ayrica kisa bir summary_text ozet alani uret (genel mac degerlendirmesi).",
    "",
    "OKUNABILIRLIK KURALI: Metinler bir spor sitesi yazarinin dogal, akici Turkcesiyle yazilmali. ORANLARI ART ARDA RAKAM RAKAM SIRALAMA KESINLIKLE YASAK (orn. 'Ajax icin 1.11, Willem II icin 21, beraberlik 11' gibi bir cumle YAZMA) - bunun yerine 'Ajax acik ara favori', 'oranlar dengeli' gibi nitel ifadeler kullan. Cumle basina en fazla bir sayi (sayi sadece Tahminim cumlelerinde market adiyla birlikte gecebilir). Arastirma metni varsa oradaki bilgiyi kisa ve dogal bir sekilde ozetle, ham veriyi (her oyuncu icin ayri sakatlik suresi, her mac icin ayri skor) tek tek sayma - genel bir tabloya donustur ('X'te birkac eksik var, Y ise daha zinde' gibi).",
    NO_FABRICATION_RULE,
    HIGHLIGHT_RULE,
    PICK_FIELD_RULE,
