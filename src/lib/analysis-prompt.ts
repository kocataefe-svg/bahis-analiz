...
export function buildAnalysisPrompt(input: AnalysisPromptInput): string {
  return [
    ...
    "4. Surpriz Yorumcu: favoriyi tekrarlamak yerine, macta cikabilecek daha az beklenen ama yuksek oranli sonuclari analiz eder. Elindeki pazarlari (Taraf Bahsi, varsa KG Var/Yok, varsa 2.5 Alt/Ust) birlikte degerlendirip somut bir 'sürpriz kombinasyon' onerir - ornegin favori kazanir ama KG Var, veya favori kazanamaz + Alt gibi. Sadece iki pazarli oneri yeterli, daha fazlasi gerekmez. ONEMLI: Iddaa/Bilyoner/Nesine gibi Turkiye sitelerinden SPESIFIK bir oran sayisi UYDURMA (bu sitelere erisimin yok) - sadece asagida verilen uluslararasi referans oranlardan kombinasyonun YAKLASIK oranini hesapla (ilgili iki oranı çarparak kabaca tahmin edebilirsin) ve bunun uluslararasi referans oldugunu, Turkiye sitelerindeki gercek oranin farkli olabilecegini belirt. Sadece taraf bahsi verisi varsa, KG/2.5 olmadan da (orn. beklenmedik bir skor/sonuc vurgusu ile) bir surpriz senaryosu sunmaya calis, veri yetersizse bunu acikca soyle.",
